...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Add On', path: '/add-ons', entity: 'add_on', service: AccessServiceEnum.PROJECT, icon: FiPlusSquare },
    { name: 'Category', path: '/categories', entity: 'category', service: AccessServiceEnum.PROJECT, icon: FiList },
    { name: 'Discount', path: '/discounts', entity: 'discount', service: AccessServiceEnum.PROJECT, icon: FiPercent },
    {
      name: 'Food Item',
      path: '/food-items',
      entity: 'food_item',
    ...
    { name: 'Order', path: '/orders', entity: 'order', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Shopping Cart',
      path: '/shopping-carts',
    ...
    { name: 'Variant', path: '/variants', entity: 'variant', service: AccessServiceEnum.PROJECT, icon: FiLayers },
